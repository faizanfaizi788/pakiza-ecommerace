  ...
  return (
    <div className="p-6 space-y-8 bg-theme-gradient-light min-h-screen">
      <div className="design-card text-center">
        <h1 className="design-text text-4xl mb-4 text-theme-800">
      ...
      <div className="design-card">
        <h2 className="design-text text-2xl mb-4 text-theme-700">
          ...
          {Object.keys(themes).map((themeName) => (
            ...
            >
              <div className="text-center">
                <div className="design-text text-lg">
                  {themes[themeName].name}
                </div>
                <div className="design-text text-sm opacity-75">
                  {themes[themeName].style}
                </div>
              </div>
            </button>
          ))}
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {/* Mock Header */}
        <div className="design-card">
          <h3 className="design-text text-xl mb-4 text-theme-700">
            Header Style
          </h3>
          <div className="flex items-center justify-between p-4 bg-white border border-theme-200">
            <div className="design-text text-lg font-bold text-theme-800">
              Pakiza
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            {[1, 2].map((i) => (
              <div key={i} className="design-card bg-theme-card p-4 space-y-2">
                ...
                <div className="design-text font-semibold text-theme-800">
                  Product {i}
                </div>
        ...
        <div className="design-card">
          ...
          <div className="space-y-2">
            <h1 className="design-text text-3xl text-theme-800">
              Large Heading
            </h1>
            <h2 className="design-text text-2xl text-theme-700">
              Medium Heading
            </h2>
            <p className="design-text text-theme-600">
              Regular paragraph text that shows the typography style for each
              theme.
            </p>
            <small className="design-text text-sm text-theme-500">
              Small text example
            </small>
          </div>
        </div>
        ...
        <div className="design-card">
          ...
          <div className="space-y-4">
            <button className="design-button bg-theme-500 text-white">
              Primary Button
            </button>
      ...
      <div className="design-card">
        ...
        <div className="grid lg:grid-cols-2 gap-4">
          <div>
            <h4 className="design-text font-semibold text-theme-800">
      ...
      <div className="design-card text-center">
        <p className="design-text text-theme-600">
          🎉 Each theme completely transforms the design language of the entire
          application!
        </p>
      </div>
    </div>
