...
const UploadProduct = () => {
  ...
  return (
    <section className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50 to-blue-50">
      <div className="p-4 sm:p-6 bg-gradient-to-br from-white to-purple-50 shadow-lg rounded-xl m-4 border border-purple-100">
      ...
      <div className="m-4 bg-gradient-to-br from-white to-purple-50 shadow-lg rounded-xl border border-purple-100 p-6">
        <form className="grid gap-6" onSubmit={handleSubmit}>
          ...
          <div>
            <p className="font-semibold text-gray-700 mb-3">Product Images</p>
            <div>
              <label
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {data.category.map((c, index) => {
                  return (
                    ...
                    >
                      <p className="text-purple-800 font-medium">{c.name}</p>
                      <div
